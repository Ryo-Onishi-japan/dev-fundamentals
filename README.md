...
働くうえで必須となるGitHub・Java・PL/SQL・AIコーディングの基礎を実践的に学ぶリポジトリです。
...
| 技術 | 習得スキル |
|------|------------|
| **GitHub** | Issue、ブランチ、PR、gh CLI |
| **Java** | クラス設計、JDBC接続 |
| **PL/SQL** | ストアドプロシージャ、トリガー |
| **AIコーディング** | 効果的なプロンプト、対話的開発 |
